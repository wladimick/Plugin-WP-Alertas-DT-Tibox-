...
class ADT_Shortcode {
    ...
    public static function render( array $atts ): string {
        ...
        <form class="eg-card eg-form alertas-dt-form" data-eg-theme="light"
              method="post" action="" novalidate data-adt-form="1">
            ...
            <h2 class="eg-form__title">Activa tus alertas DT + SII</h2>
            ...
            <div class="eg-field">
                ...
                <input class="eg-input" id="adt-name" name="subscriber_name" type="text" placeholder="Tu nombre" autocomplete="name">
            </div>

            <div class="eg-field">
                <label class="eg-label" for="adt-email">Correo electrónico</label>
                <input class="eg-input" id="adt-email" name="email" type="email" required placeholder="nombre@empresa.cl" autocomplete="email">
            </div>

            <div class="eg-field">
                <label class="eg-label" for="adt-phone">Teléfono (opcional)</label>
                <input class="eg-input" id="adt-phone" name="phone" type="tel" placeholder="+56 9 1234 5678" autocomplete="tel">
            </div>

            <label class="eg-check eg-check--consent">
                <input type="checkbox" name="consent" value="1" required>
                <span>Acepto recibir alertas informativas por email sobre nuevas publicaciones de la Dirección del Trabajo y del Servicio de Impuestos Internos.</span>
            </label>
            ...
            <p class="eg-fineprint">
                Para administrar una prueba gratuita, perfil y preferencias, <a href="<?php echo esc_url( ADT_Portal::register_url() ); ?>">crea tu cuenta</a>
                o <a href="<?php echo esc_url( ADT_Portal::login_url() ); ?>">inicia sesión</a>.
            </p>
        </form>
        ...
        <noscript>
            <form class="eg-card eg-form alertas-dt-form" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" novalidate>
                ...
                <div class="eg-field">
                    ...
                    <input class="eg-input" id="adt-email-njs" name="email" type="email" required placeholder="nombre@empresa.cl">
                </div>
                <label class="eg-check eg-check--consent">
                    <input type="checkbox" name="consent" value="1" required>
